...
### Secret Scanning
Results saved to: `./docs/reports/secrets-20260510_180442.json`

### Vulnerability Scanning
Results saved to: `./docs/reports/vulnerabilities-20260510_180442.json`

### Software Bill of Materials (SBOM)
SBOM generated and saved to: `./docs/reports/sbom-20260510_180442.json`
...
*Report location: ./docs/reports/security-audit-2026-05-10.md*
